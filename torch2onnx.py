...
def convert_onnx(net, path_module, output, opset=11, simplify=False):
    ...
    net.eval()
    torch.onnx.export(net, img, output, input_names=["input"], output_names=["output"], do_constant_folding=True, keep_initializers_as_inputs=False, verbose=False, opset_version=opset, export_params=True)    
...
if __name__ == '__main__':
    ...
    if args.output is None:
        args.output = os.path.join(args.input, "model.onnx")
